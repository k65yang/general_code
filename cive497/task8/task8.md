...
![](https://lh3.googleusercontent.com/fgZyF2z-Aybcgp-NPz_GdO0Vta4keRSc0V0YF37CINFi0itH7AYqiN3liIbThAaI77U54QeteZ-xv0rkmakNZROcbi8tK1P10FRdKffkkWPVNg5HPQRP92WieM27qwBwi2mMhu_cCNCpC09Zip9--RTUCp6S-1jcE9DkXRtxPerArh1iECnsA-cIb53V9VA0afoAHsexT7rp5wNeN-3BeDAs2m_APGPjSH01-XK1RhoukGKVyLAT6f8MF9hwj8mcYqBk-rU_fCSWzSGs5zQ5okMJo8kRiYT4EFkjLeI7NPdvAZn3EKvzzY-vTgALbjAh3ABQQ3CCb9RcON46uYAr-AnUJ0bQKhOH634rhtX70SbxHyTfuUDxvdS-8X_1dePbimBwqussE-EzEcG5kZXvGl9HtFB0P624X2hLlZjV_y8sL2ny3YfDc2s1iJrSlTY5feALB5qgiPEA7PBZzFgVWl629kB706VymvALz9A4ksOPmpB8BaTeB7krFB2QvmXJcGmBwhYuEUbrdEMhN1X_EALjDjzVUzNwDi790S1V0c-nNEDloPixI62U612pGIZvWdmILxb-6Ru-LGdOiMuPKtdlqWiofd3yX1psiMqfKmF22SWMvgl2rqBE7xDppON9IyfJ3d8bRqBX6pUPmifWpp8Mlc5hiWvSMTVUW8P1SGOt9JZljtCHCsuEqWHK=w1006-h349-no)    
...
The neural network parameters were unchanged from the defaults. 300 epochs was specified with a learning rate of 0.01 and a scheduling rate of 0.9. There are 6 input nodes and 4 output nodes (to input the various characteristices of the car). A single hidden layer consisting of 12 nodes was specified. Activation function on the hidden layer is "sigmoid" and for the output node, "softmax" is used. The loss function is "cross-entropy". The accuracy is slightly over 90% and loss less than 20%. The final plot is shown below.  
