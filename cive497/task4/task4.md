...
The more light a camera takes in, the better the picture will be and Apple's iPhone 11 follows this exact principle. The cameras on the back of the iPhone 11 consist of a wide camera, an ultra-wide camera, and a telephoto camera. The focal length of all these cameras are different, hence, the combination of these three cameras taking a single picture allow for a larger depth of field. Additionally, because of the varying focal lengths of the camera, the zoom then becomes more like an optical zoom, rather than a digital zoom. This helps to reduce distortion and minimized image quality loss when zooming.  
